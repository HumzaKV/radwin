    ...
    <div class="hfeed site" id="page">
        ...
        <div class="wrapper-fluid wrapper-navbar" id="wrapper-navbar">
            ...
            <div class="container-fluid">
               ...
               <style type="text/css">.header-US #mega-menu-wrap-megamenu #mega-menu-megamenu > li.mega-menu-item.usamenu {display: none;}</style>
                ...
                if( isset($_SERVER['HTTP_X_FORWARDED_FOR']) )
                    ...
                    if( $_country && $_country->status == 'success' ) {
                        ...
                        if ( $country_code == 'US' || $country_code == 'CA' ) {
                            printf('<style type="text/css">.header-US #mega-menu-wrap-megamenu #mega-menu-megamenu > li.mega-menu-item.usamenu {display: inline-block !important;}</style>');
                            ?>
