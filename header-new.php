<?php
global $assets; $container = get_theme_mod('understrap_container_type');
?><!DOCTYPE html>
...
<head>
    ...
    <script>(function (w, d, s, l, i) {
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-5CD82R');</script>
                    ...
                    <div class="col-12 col-sm-12 col-md-12 pull-left hidden-xl-up ">
                            ...
                            <?php if (get_global_option('show_switcher') == true) { ?>
                                ...
                                if (count($languages) > 0) {
                                    ...
                                    foreach ($languages as $l) {
                                        $url = "/events/list/" ;
                                        if($l['code'] != 'en'){
                                            $url = "/".$l['code']."/events/list/";
                                        }
                                        //str_replace('list/','',$l['url']);
                                        echo "<li><a href='" . $url . "'>" . $l['translated_name'] . "</a></li>";
                                    }
                                    echo '</ul>';
                                }
                            } ?>
                        ...
                        <a class="navbar-brand" href="<?php echo esc_url(home_url('/')); ?>"
                           ...
                           style="width: 153px; height: 51px;">
                            <img src="<?php echo $assets; ?>logo.svg" alt="login Icon">
                        </a>
                    </div>
                ...
                <div class="navbar-header text-center">
                    ...
                    <div class="navbar-toggleable-md exCollapsingNavbar top-extra-navbar">
                        <ul class="nav navbar-nav">
                            <li class="search">
                                <a href="#">
                                    <img class="icon-closed" src="<?php echo $assets; ?>search-icon.svg"
                                         alt="Search Icon">
                                    <img class="icon-open" src="<?php echo $assets; ?>search-icon-open.svg"
                                         alt="Search Icon">
                                </a>
                            ...
                            <li class="login">
                                <a href="https://radwinportal.amp.vg/" target="_blank">
                                    <img class="icon inactive" src="<?php echo $assets; ?>login-icon.svg"
                                         alt="login Icon">
                                    <span>Login</span>
                                </a>
                            </li>
