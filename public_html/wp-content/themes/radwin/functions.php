...
function load_script_footer()
{
    ...
    <script>
        jQuery(function($) {
            ...
            $(document).on("click", ".contactForm-wrapper .contactForm", function () {
                $( this ).addClass( 'cont-btn');
                if ( $( this ).hasClass( 'cont-btn')) {
                  hbspt.forms.create({
                    region: "na1",
                    portalId: "2686314",
                    formId: "43d409e8-472b-475c-bf13-fcc780013d36"
                });
              }
          });
...
add_action('wp_footer', 'load_script_footer', 99);
...
function codex_svg_animation()
{
    ...
    <div class="vector_animate">
        ...
        <svg version="1.1" id="couple" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 805.9 120" style="enable-background:new 0 0 805.9 120;" xml:space="preserve">
            <style type="text/css">
                .st0 {
                    fill: none;
                    stroke: #FFCF61;
...
function new_svg_generate()
{
    ...
    <svg version="1.1" id="couple_new" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 805.9 120" style="enable-background:new 0 0 805.9 120; -webkit-transform: scaleX(-1);
